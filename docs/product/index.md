...
WMS 작업에 필요한 다음 정보는 상품·SKU 기준정보로 관리한다.

- EA·PACK·CASE UOM과 환산수량
- 단위별 가로·세로·높이·중량
- 상품·포장 상태를 식별하는 이미지
- LOT·유효기간·시리얼 관리 여부
- 온도·위험물·취급 주의 조건

입고 검수 중 누락된 값을 보완할 수 있지만 입고 작업마다 별도 상품정보를 만드는 것은 아니다. 보완한 값은 상품 도메인에 저장하고 이후 입고·재고·출고에서 같은 기준으로 사용한다.
